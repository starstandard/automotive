...
info.add(new String[] {"sales_operations","part_order"});
...
info.add(new String[] {"core","lifecycle_status_event"});
...
info.add(new String[] {"inventory_vehicle","vehicle"});
...
info.add(new String[] {"service","service_publication"});
...
info.add(new String[] {"logistics_fulfillment","shipment_profile"});

info.add(new String[] {"logistics_fulfillment","warehouse"});
