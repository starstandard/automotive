...
The API is structured around the domain **finance** and **PayrollRun** resource as the primary entity, with several resources scoped under it via various path parameters.
